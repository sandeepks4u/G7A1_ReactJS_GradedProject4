...
const Navigation = ({ contextHandler }: Props) => {
  ...
  return (
    <Container fluid >
      ...
      >
        <Nav variant="tabs" className="navItems" style={{backgroundColor:'rgb(36, 102, 255)'}}>
          <Nav.Item >
            <Nav.Link eventKey="movies-in-theaters" className="navigation-tab" style={{color:'rgb(247, 0, 255)'}}>
              <b>Movies in Theaters</b>
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link eventKey="movies-coming" className="navigation-tab" style={{color:'rgb(247, 0, 255)'}}>
              <b>Coming Soon</b>
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link eventKey="top-rated-movies" className="navigation-tab" style={{color:'rgb(247, 0, 255)'}}>
              <b>Top Rated Movies</b>
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link eventKey="top-rated-india" className="navigation-tab" style={{color:'rgb(247, 0, 255)'}}>
              <b>Top Rated Indian Movies</b>
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
            <Nav.Link eventKey="favourite" className="navigation-tab" style={{color:'rgb(247, 0, 255)'}}>
              <b>Favourites</b>
            </Nav.Link>
          </Nav.Item>
          <Nav.Item>
